...
import { PoBreadcrumb, PoModalAction, PoModalComponent, PoNotificationService, PoTableColumn } from '@po-ui/ng-components';
...
export class UsuariosListComponent implements OnInit {
  ...
  @ViewChild('modalSalvarUsuario', { static: true }) modalSalvarUsuario: PoModalComponent;
  @ViewChild('modalEditarUsuario', { static: true }) modalEditarUsuario: PoModalComponent;
  @ViewChild('modalExcluirUsuario', { static: true }) modalExcluirUsuario: PoModalComponent;
